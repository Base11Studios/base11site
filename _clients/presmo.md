...
- **Name a feeling, get a matched tool:** tell the app how you feel and it recommends an exercise built for exactly that, in one tap.
- **60+ evidence-based exercises:** real interventions from CBT, DBT, ACT, EMDR, grounding, somatic work, breathwork, and MBSR, not generic tips.
- **Built for the acute moment:** most tools run 30 seconds to 3 minutes, made for panic, racing thoughts, and sleepless nights.
- **Help Now and Daily Practice:** a fast path for the bad days, and a gentle daily ritual of intentions, gratitude, and reflection for the regular ones.
- **Insights that learn what works for you:** the app tracks which tools actually move your felt state and tells you, "here is what helps when you are anxious."
- **Hundreds of affirmations and inspirations** for self-worth, confidence, and calm.
- **Private by design:** no account required, stored on your device and backed up through your own private iCloud. No ads, no data selling.

## Screenshots

![Name how you feel and get a matched exercise]({{ site.baseurl }}/images/screens/present-sense/feeling-match.jpg)
![Help now, or every day]({{ site.baseurl }}/images/screens/present-sense/home.jpg)
![5-4-3-2-1 grounding in two minutes]({{ site.baseurl }}/images/screens/present-sense/grounding.jpg)
![Catch the thought and reframe it with guided CBT]({{ site.baseurl }}/images/screens/present-sense/reframe.jpg)
![Insights that show what is working for you]({{ site.baseurl }}/images/screens/present-sense/insights.jpg)
{: class="screenshots"}
